...
static const int fleet_size = 32000;
...
static const std::string baseDir = "/ocean/projects/eng200002p/mbruchon/RidePooling/";
static const std::string city = "chicago";
static const std::string costs = "private"; //social, dists
...
static const int max_node = 31674; //264346;

static const std::string stdOutput = "/dev/tty";
...
typedef std::vector<std::pair<unsigned short int, unsigned int>> stMap;
