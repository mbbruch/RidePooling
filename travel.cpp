...
int TravelHelper::travel(Vehicle& vehicle, Request *reqs[], int numReqs, bool decided, bool observeReqTimeLimits, bool bFeasibilityCheck) {
    ...
    */
    ...
    dfs(vehicle, reqs, numReqs, target, src_dst, path, schedule, occupancyStart, 0, beginTime, 0, decided, observeReqTimeLimits, bFeasibilityCheck); //todo prob add offset, "this is how much to offset"
