...
const char Edge_File[] = "/ocean/projects/eng200002p/mbruchon/RidePooling/In/austin.edge";// In the first line, two integers n, m represent the number of points and edges, 
									//and in the next m lines, three integers U, V, C represent U->V has an edge of length C
const char Node_File[] = "/ocean/projects/eng200002p/mbruchon/RidePooling/In/austin.co"; //A total of N lines, an integer and two real numbers for each line id, x, y represents the longitude and latitude 
...
const char GPTree_File[] = "/ocean/projects/eng200002p/mbruchon/RidePooling/In/GP_Tree.data";
